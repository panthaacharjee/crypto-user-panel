        ...
        <table className='w-full mt-10' >
            <thead className='border-2 border-black bg-[#CB0881]'>
                <tr className='w-full text-white'>
                    ...
                    <th className='border-2 border-[#CB0881] px-3 py1 w-3/12'>Address</th>
            ...
            <tbody>
                {array?.slice(first, last).map((val)=>{
                    ...
                    return(
                        <tr className='w-full text-center '>
                                ...
                                <td className='border-2 border-[#CB0881] px-3 py1 w-3/12'>{val?.address}</td>
                                <td className='border-2 border-[#CB0881] px-3 py1 w-3/12'>{val?.amount.toFixed(2)}</td>
